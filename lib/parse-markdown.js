...
const md = require('markdown-it')({
  ...
  highlight: function (str, lang) {
    ...
    if (lang && Prism.languages[lang]) {
      try {
        return `<pre class=\"language-${lang}\"><code class=\"language-${lang}\">${Prism.highlight(str, Prism.languages.javascript)}</code></pre>`;
      } catch(ex) {
 ...
 *
 * @function _renderCodeBlocks
 * @param {String} templateString The template string to scan for code blocks.
 * @return {String}
 */
